...
def ANN(X_train, X_test, y_train, y_test, StandScaler=None):
    ...
    precision = precision_score(predict_results, y_test.ravel(), average='weighted')
    recall = recall_score(predict_results, y_test.ravel(), average='weighted')
    f1 = f1_score(predict_results, y_test.ravel(), average='weighted')
    print(acc)
    print(precision)
    print(recall)
    print(f1)
